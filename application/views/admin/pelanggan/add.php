                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="user_id" name="user_id" required>
                                            ...
                                            <?php foreach ($users as $user): ?>
                                                <option value="<?= $user->user_id ?>" <?= set_select('user_id', $user->user_id) ?>>
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="level_id" name="level_id" required>
                                            ...
                                            <?php foreach ($levels as $level): ?>
                                                <option value="<?= $level->level_id ?>" <?= set_select('level_id', $level->level_id) ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="alamat" name="alamat" rows="3" required><?= set_value('alamat') ?></textarea>
