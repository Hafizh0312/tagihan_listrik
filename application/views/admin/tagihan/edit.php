...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Edit Tagihan Listrik</h1>
                ...
                <div class="card border-0 shadow">
                    <div class="card-header bg-warning text-white">
                        <h5 class="card-title mb-0">
                            <i class="fas fa-edit me-2"></i>Edit Data Tagihan
                        </h5>
                    </div>
                    <div class="card-body">
                        <?= form_open('admin/tagihan/update/' . $tagihan->tagihan_id) ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="pelanggan_id" name="pelanggan_id" required>
                                            ...
                                            <?php foreach ($pelanggan as $p): ?>
                                                <option value="<?= $p->pelanggan_id ?>" 
                                                        <?= ($p->pelanggan_id == $tagihan->pelanggan_id) ? 'selected' : '' ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="bulan" name="bulan" required>
                                            ...
                                            <?php for ($i = 1; $i <= 12; $i++): ?>
                                                <option value="<?= $i ?>" <?= ($i == $tagihan->bulan) ? 'selected' : '' ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="tahun" name="tahun" required>
                                            ...
                                            <?php for ($i = date('Y') - 2; $i <= date('Y') + 1; $i++): ?>
                                                <option value="<?= $i ?>" <?= ($i == $tagihan->tahun) ? 'selected' : '' ?>>
                                                    <?= $i ?>
                                                </option>
                                            <?php endfor; ?>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="meter_awal" name="meter_awal" 
                                               value="<?= $tagihan->meter_awal ?>" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="meter_akhir" name="meter_akhir" 
                                               value="<?= $tagihan->meter_akhir ?>" required>
    ...
    <script>
        // Get current values
        let currentMeterAwal = <?= $tagihan->meter_awal ?>;
        let currentMeterAkhir = <?= $tagihan->meter_akhir ?>;
        let currentTarif = <?= $tagihan->tarif_per_kwh ?>;
        let currentDaya = <?= $tagihan->daya ?>;
        ...
        function updateCalculation() {
            ...
            const totalTagihan = totalKwh * currentTarif;

            document.getElementById('total_kwh_preview').value = totalKwh.toLocaleString();
            document.getElementById('tarif_preview').value = currentTarif.toLocaleString();
            document.getElementById('total_tagihan_preview').value = totalTagihan.toLocaleString();
            document.getElementById('daya_preview').value = currentDaya.toLocaleString();
        }
        ...
        document.getElementById('pelanggan_id').addEventListener('change', function() {
            ...
            if (pelangganId) {
                ...
                // For now, we'll use the current values
                updateCalculation();
            }
        });
    </script>
